...
### RAGAS 평가 결과 (Q&A 데이터 20개 샘플 기준)

| 메트릭 | 점수 | 설명 |
|--------|------|------|
| **Faithfulness** | 0.99 | 답변이 참조 문서에 충실한 정도 |
| **Answer Relevancy** | 0.83 | 답변이 질문과 관련된 정도 |
| **Context Precision** | 0.97 | 검색 문서의 질문 관련성 정도 |

> 측정 환경: GPT-4-turbo(답변 생성), GPT-4o(평가), Voyage rerank-2.5(리랭킹)
> 평가 도구: RAGAS v0.1.0
